...
1. The top 5 products that contribute the most to revenue (calculated as unit price * quantity sold) across all orders.

2. Supplier's name and the name of their best-selling product (in terms of quantity) that has been ordered.
